...
_node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).ready(function () {
  _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()('.glazing__slider').slick({
    infinite: true,
    slidesToShow: 5,
    slidesToScroll: 1,
    responsive: [{
  ...
  _node_modules_jquery_dist_jquery__WEBPACK_IMPORTED_MODULE_0___default()('.decoration__slider').slick({
    infinite: true,
    slidesToShow: 4,
    slidesToScroll: 1,
    responsive: [{
